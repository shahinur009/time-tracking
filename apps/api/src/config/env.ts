...
export const env = {
  ...
  CLICKUP_WEBHOOK_BASE: process.env.CLICKUP_WEBHOOK_BASE || "",
  ...
  CLICKUP_ENTRY_POLL_MIN: Number(process.env.CLICKUP_ENTRY_POLL_MIN || 30),
  CLICKUP_ENTRY_PULL_DAYS: Number(process.env.CLICKUP_ENTRY_PULL_DAYS || 30),
};
